			...
			if (empty($post_username)) {
				...
				if ($insert_user == TRUE) {
					...
					if (empty($post_id)) {
						...
						$update_user = mysqli_query($db, "UPDATE users SET password = '$post_password' WHERE id = '$post_id'");
						if ($update_user == TRUE) {
							$msg_type = "success";
							$msg_content = "<b>Berhasil:</b> Pengguna berhasil diubah.";
						} else {
							$msg_type = "error";
							$msg_content = "<b>Gagal:</b> Error system.";
						}
...
?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    <div class="card-box">
                                        <h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-list"></i> Manajemen Pengguna</h4>
											<?php 
											if ($msg_type == "success") {
											?>
    										...
    										<div class="col-md-6">
    											<a href="javascript:;" onclick="users('<?php echo $cfg_baseurl; ?>admin/usersss/add/index.php')" class="btn btn-sm btn-info"><i class="fa fa-plus" title="Tambah"></i>Tambah</a>
    										</div>
    										<div class="col-md-6">
    										</div>
    										</div>
...
// end paging config
												...
												?>
													<tr>
													    <td><a href="javascript:;" onclick="users('<?php echo $cfg_baseurl; ?>admin/usersss/detail/index.php?id=<?php echo $data_show['id']; ?>')" class="badge badge-info">#<?php echo $data_show['id']; ?></a></td>  
													    <td><?php echo $data_show['username']; ?></td>
														<td><?php echo $data_show['password']; ?></td>
														<td align="center">
														<a href="javascript:;" onclick="users('<?php echo $cfg_baseurl; ?>admin/usersss/delete/index.php?id=<?php echo $data_show['id']; ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash" title="Hapus"></i></a>
														</td>
													</tr>
												<?php
												}
